...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		if (empty(trim($this->form->birthdate))) {
			...
			getMessages()->addError('Wprowadź swój gender ( male / female / other )');
		}
		...
		if ( $d === false ){
			getMessages()->addError('Zły format daty. Przykład: 2015-12-20');
                ...
                if (!in_array($this->form->gender, ["male", "female", "other"])) {
                    getMessages()->addError('Zły format genderu. Przykład: ( male / female / other )');
                }
